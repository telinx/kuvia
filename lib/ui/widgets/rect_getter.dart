...
class RectGetter extends StatefulWidget {
  static Map<String, dynamic> globlaKeys = {};
  ...
  static GlobalKey<_RectGetterState> createGlobalKey({String keyId}) {
    if(null != keyId && RectGetter.globlaKeys[keyId] != null){
      return RectGetter.globlaKeys[keyId];
    }
    GlobalKey<_RectGetterState> globalKey = GlobalKey<_RectGetterState>();
    if(null != keyId) RectGetter.globlaKeys[keyId] = globalKey;
    return globalKey;
  }
