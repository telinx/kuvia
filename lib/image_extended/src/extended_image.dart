...
import '../src/extended_image_border_painter.dart';
import '../src/gesture/extended_image_gesture.dart';
import '../src/extended_image_typedef.dart';
import '../src/extended_image_utils.dart';
import '../src/image/extended_raw_image.dart';
import '../../extended_image_library/extended_image_library.dart';
...
//            autoCancel: autoCancel,
  ...
  final LongPressTap onLongPress;
            ...
            current = Container(
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    flex: 1,
                    child: ProgressView(padding : EdgeInsets.only(bottom: 10.0))
                  )
